...
INSERT INTO
	Users (nom, username, motDePasse, mail, groupe)
VALUES
	(
		'Mamie BA',
		'mamie9',
...
ALTER TABLE
	Users
ADD
	CONSTRAINT fk_users_groupe FOREIGN KEY(groupe) REFERENCES Groupe(id);

GRANT ALL PRIVILEGES ON mglsi_news.* TO 221shadow @localhost;